 ...
 * 
 * 
 * Class that represent a minefield. It is constitued by a boolean
 * matrix. Each elements say if there is a mine there or not.
 */
public class DMinefield {
     ...
     */
    public int newCustomEmptyField(DLevel selectedLevel, int fieldLenght, int fieldWidth, int numberOfMineRequired) {
