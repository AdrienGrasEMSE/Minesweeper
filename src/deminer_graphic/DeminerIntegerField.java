 ...
 */
public class DeminerIntegerField extends DeminerStringField {
     ...
     */
    public DeminerIntegerField(DeminerFont selectedFont, int fontSize, Color fontColor, Color defaultColor, Color flyoverColor) {
